    ...
    season1: {
        seasonInfo: {
            episodeInfo: [
                ...
                {episdoe: 10, episodeName: "Demotion"},
...
//Pick an episode to log in the terminal - using dot notation, walk through the netflix object and print off the episode, number, and the episode name
...
//Object.keys returns an array consisting of the keys in our object

console.log(Object.keys(spaceJam.toonSquad));

console.log(Object.keys(spaceJam.toonSquad).toString());
//represents it as a string as opposed to an array listing
//toString works for arrays, functions, etc.
