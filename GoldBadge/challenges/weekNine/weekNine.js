...
const filterPresidents = presidents.filter(presidents => presidents.year >=1900 && presidents.year<=1999);

console.log(filterPresidents);
...
const nameofPresidents = presidents.map(presidents => `${presidents.first} ${presidents.last}`);

console.log(nameofPresidents);
...
for(i=0; i<=presidents.length; i++){
    presidents => presidents.push(key + ":" + value);
};
